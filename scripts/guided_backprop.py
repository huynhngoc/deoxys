...
if __name__ == '__main__':
    ...
    for layer in layer_list[-3:]:
        guided_backprops = deo.guided_backprop(layer, imgs, mode='max')
        ...
        plt.suptitle('Guided Backprop at Layer {}'.format(layer))
        # plt.show()
        plt.savefig(
            '../../results/hn_vis/guided_backprop_max_layer_{}'.format(layer))
