...
if __name__ == '__main__':
    ...
    for layer in layer_list[-1:]:
        backprops = deo.backprop(layer, imgs, mode='custom', loss_fn=loss_fn)
        ...
        plt.suptitle('Backprop True Positive at Layer {}'.format(layer))
        # plt.show()
        plt.savefig(
            '../../results/hn_vis/backprop_tp_layer_{}'.format(layer))
...
for layer in layer_list[-1:]:
    ...
    plt.suptitle('Backprop False Positive at Layer {}'.format(layer))
    # plt.show()
    plt.savefig(
        '../../results/hn_vis/backprop_fp_layer_{}'.format(layer))
