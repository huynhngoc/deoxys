...
if __name__ == '__main__':
    ...
    # # Add experiment - uncomment when run for the first time
    # config = read_file('examples/json/unet-sample-config.json')
    # inserted_id = me.new_experiment_from_full_config(
    #     'HnN Config', config, '**your description**')
    # exps = me.experiments
    # # List again
    # print(exps[['name', 'description']])
    ...
    # # Start a new session
    # new_session = me.run_new_session(experiment_id, epochs=2,
    #                                  log_base_path='../../hn_perf/logs_db')
    ...
    # me.continue_session(
    #     session_id, 2, log_base_path='../../hn_perf/logs_db')
    ...
    #     session_ids, 2, log_base_path='../../hn_perf/logs_db')
